...
class OracleDBQueryBuilderTest extends TestCase
{
    ...
    public function test_pipe_callback()
    {
    ...
    public function test_or_where_time_oracle()
    {
        $builder = $this->getBuilder();
        $builder->select('*')->from('users')->whereTime('created_at', '<=', '10:00')->orWhereTime('created_at', '>=', '22:00');
        $this->assertSame('select * from "users" where TO_CHAR("created_at", \'HH24:MI:SS\') <= ? or TO_CHAR("created_at", \'HH24:MI:SS\') >= ?', $builder->toSql());
        $this->assertEquals([0 => '10:00', 1 => '22:00'], $builder->getBindings());
    }

    public function test_where_past()
    {
    ...
    public function test_where_past_uses_array()
    {
    ...
    public function test_where_today_oracle()
    {
        Carbon::setTestNow('2022-04-20 12:34:56.123456');

        $builder = $this->getBuilder();
        $builder->select('*')->from('posts')->whereToday('published_at');
        $this->assertSame('select * from "posts" where TO_CHAR("published_at", \'YYYY-MM-DD\') = ?', $builder->toSql());
        $this->assertEquals([0 => '2022-04-20'], $builder->getBindings());

        $builder = $this->getBuilder();
        $builder->select('*')->from('posts')->where('id', '=', 1)->orWhereToday('published_at');
        $this->assertSame('select * from "posts" where "id" = ? or TO_CHAR("published_at", \'YYYY-MM-DD\') = ?', $builder->toSql());
        $this->assertEquals([0 => 1, 1 => '2022-04-20'], $builder->getBindings());
    }

    public function test_passing_array_to_where_today_oracle()
    {
        Carbon::setTestNow('2022-04-20 12:34:56.123456');

        $builder = $this->getBuilder();
        $builder->select('*')->from('posts')->whereToday(['published_at', 'held_at']);
        $this->assertSame('select * from "posts" where TO_CHAR("published_at", \'YYYY-MM-DD\') = ? and TO_CHAR("held_at", \'YYYY-MM-DD\') = ?', $builder->toSql());
        ...
        $this->assertSame('select * from "posts" where "id" = ? or TO_CHAR("published_at", \'YYYY-MM-DD\') = ? or TO_CHAR("held_at", \'YYYY-MM-DD\') = ?', $builder->toSql());
        $this->assertEquals([0 => 1, 1 => '2022-04-20', 2 => '2022-04-20'], $builder->getBindings());
    }

    public function test_where_future()
    {
    ...
    public function test_passing_array_to_where_future()
    {
    ...
    public function test_or_where_between_columns()
    {
        $builder = $this->getBuilder();
    ...
    public function test_or_where_not_between_columns()
    {
        $builder = $this->getBuilder();
    ...
    public function test_where_value_between()
    {
        $builder = $this->getBuilder();
    ...
    public function test_or_where_value_between()
    {
        $builder = $this->getBuilder();
    ...
    public function test_where_value_not_between()
    {
        $builder = $this->getBuilder();
    ...
    public function test_or_where_value_not_between()
    {
        $builder = $this->getBuilder();
    ...
    public function test_basic_where_ins_exception()
    {
    ...
    public function test_where_fulltext_oracle()
    {
        $this->expectException(RuntimeException::class);
    ...
    public function test_or_where_all()
    {
        $builder = $this->getBuilder();
    ...
    public function test_in_random_order_oracle()
    {
        $builder = $this->getBuilder();
        $builder->select('*')->from('users')->inRandomOrder();
        $this->assertSame('select * from "users" order by DBMS_RANDOM.VALUE', $builder->toSql());
    }
    ...
    public function test_having_expression()
    {
        $builder = $this->getBuilder();
    ...
    public function test_get_count_for_pagination_with_union_orders()
    {
        $builder = $this->getBuilder();
    ...
    public function test_get_count_for_pagination_with_union_limit_and_offset()
    {
        $builder = $this->getBuilder();
    ...
    public function test_or_wheres_have_consistent_results()
    {
        $queries = [];
        $builder = $this->getBuilder();
    ...
    public function test_basic_select_not_using_quotes()
    {
        ...
        $this->assertSame('select id from users where id = ?', $builder->toSql());

        $builder = $this->getBuilder(quoting: false);
        $builder->select('id')->from('users')->orderBy('id');
        $this->assertSame('select id from users order by id asc', $builder->toSql());
    }
    ...
    public function test_union_not_using_quotes()
    {
        $builder = $this->getBuilder(quoting: false);
        $builder->select('*')->from('users')->where('id', '=', 1);
        $builder->union($this->getBuilder(quoting: false)->select('*')->from('users')->where('id', '=', 2));
        $this->assertSame('(select * from users where id = ?) union (select * from users where id = ?)', $builder->toSql());
        $this->assertEquals([0 => 1, 1 => 2], $builder->getBindings());
    }
