...
class OracleDBOCIStatementTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        if (! extension_loaded('oci8')) {
            ...
            $this->stmt = m::mock(new \TestOCIStatementStub('oci8 statement', $this->oci, '', ['fake' => 'attribute']));
    ...
    public function testDebugDumpParams()
    {
        ...
        $stmt = new \TestOCIStatementStub(true, true, 'select * from table where id = :0 and name = :1', []);
        $var = 'Hello';
