...
RUN mkdir -p /opt/oracle \
    ...
    && wget -q https://download.oracle.com/otn_software/linux/instantclient/${INSTANT_CLIENT_DIR}/instantclient-sdk-linux.arm64-${INSTANT_CLIENT_VERSION}.zip \
    && unzip -o instantclient-basic-linux.arm64-${INSTANT_CLIENT_VERSION}.zip \
    && unzip -o instantclient-sdk-linux.arm64-${INSTANT_CLIENT_VERSION}.zip \
    && rm *.zip \
